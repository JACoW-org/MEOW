...
./venv/bin/pip install starlette uvicorn websockets uvloop anyio redis minify_html odfpy lxml orjson nltk ulid pymupdf rdflib jinja2 aiohttp unidecode pytz supervisor
