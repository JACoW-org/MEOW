...
async def collecting_sessions_and_materials(
    ...
    async with create_task_group() as tg:
        ...
        tg.start_soon(
            download_materials, event.get("url"), cookies, settings, materials
        )
...
async def download_sessions(
    event_url: str, cookies: dict, settings: dict, sessions: list
) -> None:
...
async def download_materials(
    event_url: str, cookies: dict, settings: dict, materials: list
) -> None:
