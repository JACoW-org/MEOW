...
# from meow.services.local.event.find_conference import get_conference_session_slots_entities, \
#     get_conference_session_slots_conveners_entities, get_conference_session_event_entity, \
#     get_conference_session_slot_contribution_entities, \
#     get_conference_session_slot_contribution_speakers_entities, \
