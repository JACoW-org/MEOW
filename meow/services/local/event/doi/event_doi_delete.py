...
async def delete_contribution_doi(proceedings_data: ProceedingsData, cookies: dict, settings: dict):
    """ """

    logger.info('delete_contribution_doi - delete_contribution_doi')
    ...
    async with capacity_limiter:
        ...
        try:
            ...
            if doi_exists:
                ...
                response = await delete_json(url=doi_url, auth=auth)
