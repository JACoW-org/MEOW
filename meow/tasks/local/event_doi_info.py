...
from meow.services.local.event.event_doi_info import event_doi_info
...
class EventDoiInfoTask(AbstractTask):
    """EventDoiInfoTask"""
    ...
    async def run(self, params: dict, context: dict = {}) -> AsyncGenerator[dict, None]:
        ...
        async for r in event_doi_info(event, cookies, settings):
