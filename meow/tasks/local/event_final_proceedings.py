...
class EventFinalProceedingsTask(AbstractTask):
    ...
    async def run(
        self, params: dict, context: dict | None = None
        ...
        tasks: list[ProceedingsTask] = [
            ProceedingsTask(
                code="collecting_sessions_and_materials",
                text="Collecting Sessions and Materials",
            ),
            ProceedingsTask(
                code="collecting_contributions_and_files",
                text="Collecting Contributions and Files",
            ),
            ProceedingsTask(
                code="adapting_proceedings",
                text="Adapting Final Proceedings",
            ),
            ProceedingsTask(
                code="clean_static_site",
                text="Clean Static Site",
            ),
            ProceedingsTask(
                code="download_event_materials",
                text="Download Event Materials",
            ),
            ProceedingsTask(
                code="download_contributions_papers",
                text="Download Contributions Papers",
            ),
            ProceedingsTask(
                code="download_contributions_slides",
                text="Download Contributions Slides",
            ),
            ProceedingsTask(
                code="download_contributions_posters",
                text="Download Contributions Posters",
            ),
            ProceedingsTask(
                code="read_papers_metadata",
                text="Read Papers Metadata",
            ),
            ProceedingsTask(
                code="validate_contributions_papers",
                text="Validate Contributions Papers",
            ),
            ProceedingsTask(
                code="extract_contribution_references",
            ...
            ProceedingsTask(
                code="manage_duplicates",
                text="Manage Contributions Duplicates",
            ),
            ProceedingsTask(
                code="write_papers_metadata",
                text="Write Papers Metadata",
            ),
            ProceedingsTask(
                code="generate_contributions_groups",
                text="Generate Contributions Groups",
            ),
            ProceedingsTask(
                code="concat_contribution_papers",
            ...
            ProceedingsTask(
                code="generate_inspirehep_payloads",
            ...
            ProceedingsTask(
                code="generate_proceedings",
                text="Generate Final Proceedings",
            ),
            ProceedingsTask(
                code="link_static_site",
                text="Link Static site",
            ),
        ]

        yield dict(type="progress", value=dict(phase="init_tasks_list", tasks=tasks))
