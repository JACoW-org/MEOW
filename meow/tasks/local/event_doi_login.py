...
from meow.services.local.event.event_doi_login import event_doi_login
...
class EventDoiLoginTask(AbstractTask):
    """EventDoiLoginTask"""
    ...
    async def run(
        ...
        async for r in event_doi_login(event, cookies, settings):
