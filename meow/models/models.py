...
# from meow.models.conference import Conference, SessionSlot, Creator, Folder, Chair, Material, Resource, \
#     SessionSlotContribution, SessionEvent, SessionEventConvener, SessionSlotConvener, Author, CoAuthor, \
#     PrimaryAuthor, Speaker, Attachment
#
#
